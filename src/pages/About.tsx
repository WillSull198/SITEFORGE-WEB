      ...
      <section className="py-32 px-6 bg-white overflow-hidden">
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-16 items-center">
           ...
           <div className="bg-bg-tinted p-10 rounded-card border border-border-light relative flex flex-col items-center gap-4 text-center">
              <div className="w-16 h-16 bg-amber-base flex items-center justify-center rounded-lg shadow-lg">
                 <span className="text-white font-black text-2xl italic uppercase tracking-tighter">S</span>
              </div>
              <div className="space-y-1">
                 <div className="font-bold text-text-primary">Brisbane, QLD</div>
                 <div className="text-sm text-text-tertiary">Headquarters</div>
              </div>
              <div className="flex items-center gap-2 text-[10px] font-bold text-amber-dark uppercase tracking-widest bg-bg-amber-soft px-4 py-1.5 rounded-full">
